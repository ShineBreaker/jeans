  ...
  (package
    ...
    (source
      (origin
        ...
        (sha256
          (base32
           "0xgqgha21d198dc1cq4ysdylwn4db5w70mbixr7830sswszvl6dr"))
    ...
    (synopsis "Vimix is a flat Material Design theme for GTK 3, GTK 2 and Gnome-Shell etc.")
    (description "Vimix is a flat Material Design theme for GTK 3,
  ...
  (package
    ...
    (source
      (origin
        ...
        (sha256
          (base32
           "03gs4hxnwkvyxg6wmhlilvc3srdq7vhvsyhrmz5d36ad3n4ar8pm"))))
    ...
    (description "Vimix kde is a flat Design theme for KDE Plasma desktop.
